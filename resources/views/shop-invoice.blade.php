        ...
        <div class="content-padding">
            <div class="seller-invoice-meta-container"> <div class="seller-invoice-meta-column">
                    <div class="seller-info">
                        <span class="text-strong">{{ $shop->relationLoaded('translation') && $shop->translation ? $shop->translation->title : ($shop->seller ? $shop->seller->firstname . ' ' . $shop->seller->lastname : 'N/A') }}</span>
                        <span class="text-common">Mobile: {{ $shop->phone ?: 'N/A' }}</span>
                        <span class="text-common">Email: {{ $shop->seller && $shop->seller->email ? $shop->seller->email : ($shop->email ?: 'N/A') }}</span>
                        <span class="text-common">Address: {{ $shop->relationLoaded('translation') && $shop->translation ? $shop->translation->address : 'N/A' }}</span>
                    </div>
